...
- The UI edits visual prompts and narration, imports scene media, offers three caption styling presets, project background music, timeline SFX, scene reordering, and duration-preserving cut/black-fade/white-fade transitions. Advanced batch editing, more transition families and Wan are future additions.
...
1. Add an evidence review/approval pass before final rendering if real content reviews reveal unsupported claims.
2. Improve project editing with focused batch operations if needed by real use.
