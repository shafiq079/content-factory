...
1. Add focused scene batch editing for repeated safe operations such as audio mode and transitions.
2. Add another modular video provider such as Wan.
3. When a GPU becomes available, validate LTX Fast vs DFR Quality and tune generation based on real outputs.
